        ...
        for item in file:
            ...
            if row_counter > 1:
                if float(my_list[6]) < luck_threshold:
                    character_dict = {'Occupation': my_list[0], 'Strength': my_list[1],
                                      'Agility': my_list[2], 'Stamina': my_list[3],
                                      'Personality': my_list[4], 'Intelligence': my_list[5],
                                      'Armor': my_list[7], 'Weapon': my_list[8]}
